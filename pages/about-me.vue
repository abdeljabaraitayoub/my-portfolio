  ...
  <main v-if="!loading" id="about-me" class="page">
    ...
    <div id="page-menu" class="flex">
      ...
      >
        ...
        <div id="contact-sources" class="hidden lg:flex lg:flex-col my-2 w-60">
          <div
          ...
          >
            ...
            <a
              v-if="key === 'email'"
              :href="'mailto:' + source"
              class="font-fira_retina text-menu-text hover:text-white overflow-hidden text-ellipsis whitespace-nowrap"
            >
              {{ source }}
            </a>
            <a
        ...
        <div id="gists-content" class="flex">
          ...
          >
            ...
            <div class="flex flex-col overflow-scroll">
              ...
              <GistSnippet
                data-aos="fade-down"
                v-for="(gist, key) in config.public.dev.gists"
                :key="key"
                :id="gist"
              />
            </div>
